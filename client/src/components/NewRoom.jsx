...
export default function NewRoom({
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-screen bg-black bg-opacity-30 flex items-center justify-center z-50">
      <div className="bg-[#e9ecef] rounded-xl shadow-lg p-5 max-w-md text-center flex flex-col">
        <div className="flex flex-col gap-4 justify-center">
          ...
          <div className="flex items-center justify-between bg-[#dde3ea] px-3 py-1 w-full rounded-lg leading-5 max-md:px-2 max-md:text-base">
